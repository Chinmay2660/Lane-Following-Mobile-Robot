...
// Outputs:
//  pixels: A pointer to a byte array. It will contain the pixel data, width: An int pointer to store the width of the image in pixels, height: An int pointer to store the height of the image in pixels
...
void ReadImage(const char *fileName, byte **pixels, int32 *width, int32 *height, int32 *bytesPerPixel)
{
        ...
        *pixels = (byte *)malloc(totalSize);
        // Read the pixel data Row by Row. Data is padded and stored bottom-up
        int i = 0;
...
// Inputs
//  fileName: The name of the file to save, pixels: Pointer to the pixel data array, width: The width of the image in pixels, height: The height of the image in pixels
